...
function setupPieces() {
  for (let i = 0; i < pieces.length; i++) {
    ...
    pieces[i].style.cursor = "grabbing";
...
function drop(ev) {
  ...
  if (
    ...
    let content = "White to Move";
    if(isWhiteTurn)
    {
        content = "White to Move";
        document.getElementById("whosTurn").style.color = "white";
    }
    else
    {
        content = "Black to Move";
        document.getElementById("whosTurn").style.color = "black";
    }
    document.getElementById("whosTurn").innerHTML = content;
